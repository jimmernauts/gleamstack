...
@external(javascript, "./db2.ts", "do_get_one_recipe_by_slug")
...
@external(javascript, "./db2.ts", "do_subscribe_to_one_recipe_by_slug")
...
@external(javascript, "./db2.ts", "do_get_recipes")
...
@external(javascript, "./db2.ts", "do_get_tagoptions")
...
@external(javascript, "./db2.ts", "do_subscribe_to_recipe_summaries")
